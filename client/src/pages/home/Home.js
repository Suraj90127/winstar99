...
const Home = () => {
  ...
  return (
    <Layout>
          ...
          <div className="banner-notice bg-body shadow-lg mt-[0.5rem] rounded-full flex items-center justify-between">
            ...
            <span className="float-end text-xl  relative mr-2">
              <Link
                ...
                className="flex items-center blue-linear p-2 rounded-2xl px-8"
              >
      ...
      {topup && (
        <div className="absolute top-16 left-0 right-0 flex m-auto flex-col h-[28rem] bg-light mx-8 pb-2 rounded-xl z-[9999]">
          ...
          <div className="overflow-y-auto">
            ...
            <img src="https://i.ibb.co/cSPb9f3X/popup.png" alt="" />
          </div>
          <button
        ...
        <div className="absolute top-20 left-0 right-0 flex m-auto flex-col bg-light h-[28rem] mx-8 pb-2 rounded-xl z-[9999]">
          ...
          <div className="pt-5 text-color text-[15px] bg-light overflow-y-auto">
            ...
            <div className="mx-3 mt-3 text-center">
              ...
              <span className="text-[15px] text-[#0468eb]">
                Lottery7SVIPBot
              </span>
            </div>
          </div>
