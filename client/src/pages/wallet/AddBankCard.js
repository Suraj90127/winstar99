    ...
    <>
      ...
      <div className="container-section">
        ...
        <div className="mt-7">
          ...
          <input
            type="text"
            className="w-full mt-2 blue-linear text-white rounded-md p-2 focus:border-slate-700 ps-6 flex items-center focus:border focus:outline-none cursor-pointer   placeholder:text-sm placeholder:text-slate-500"
          ...
          {open && (
            <div className="bank-option bg-body p-4">
              <input
                type="text"
                className="w-full mt-2 bg-body text-whites rounded-md p-2 focus:border-slate-700 ps-6 flex items-center focus:border focus:outline-none placeholder:text-sm placeholder:text-slate-500"
        ...
        <div className="mt-4">
          ...
          <div className="mt-3 flex justify-between relative">
            ...
            <span
              ...
              type="submit"
              className="absolute blue-linear right-3 top-2 cursor-pointer text-sm px-6 py-2 rounded-full"
            >
