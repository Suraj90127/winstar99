      ...
      <div className="p-4 m-4 bg-light flex flex-col items-center rounded ">
        ...
        <div className="text-xs text-whites font-sm space-y-1 max-w-xl">
          ...
          <p className="flex items-start gap-1">
            ...
            winstar99 works with more than 10,000 online live game dealers and
          ...
          <p className="flex items-start gap-1">
            ...
            winstar99 supports fast deposit and withdrawal and looks forward to
            your visit.
          </p>
          <br />
          ...
          <p className="text-[#f95959]">
            winstar99 only accepts customers above the age of 18.
          </p>
        </div>
      </div>
    </div>
