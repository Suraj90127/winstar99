    ...
    <>
      ...
      <div className="dailytask-banner">
        <div className="w-[70%]">
          ...
          <p className="fs-sm">
            Complete weekly/daily tasks to recieve rich rewards{" "}
          </p>
          <p className="fs-sm">
            Weekly rewards cannot be accumulated to the next week, and daily
            rewards cannot be accumulated to the next days.
          </p>
        </div>
      </div>
      <div className="container-section">
        <div className="nav-bg rounded-md mt-3">
          <div className="flex justify-between items-center">
            <h2 className="heading-h2 color-yellow-bg-200 text-white rounded-tl-xl rounded-br-xl px-3 py-1 text-base font-medium">
              Newbie gift pack
            </h2>
            <p
          ...
          <div className="bg-color-l mx-2 px-3 py-1 rounded-md gray-100 text-sm">
            test
          </div>
          <div className="flex justify-between items-center p-2 border-b-3 border-[bg-color-l]">
            ...
            <div className="flex items-center">
              ...
              <p className="color-yellow-200 text-[14px] ms-1 font-medium">
                ₹2.00
              </p>
            </div>
          </div>
          <div className="m-2 pb-3">
            <button className="border py-1 rounded-3xl text-base w-full border-blue-500 heading-h3 blue-color-300">
              to complete
            </button>
          </div>
        </div>
