...
const PartnerRewards = () => {
  ...
  return (
    <div className="bg-[#F7F8FF] text-black max-w-md mx-auto rounded-xl shadow-lg ">
      <CopyCopmponent
        copyPopup={copyPopup}
      ...
      <div className="relative w-full overflow-hidden mb-4">
        ...
        <div className="absolute top-1/2 right-6 transform -translate-y-1/2">
          ...
          <p className="bg-gradient-to-r from-orange-300 to-orange-400 px-4 py-1 rounded-full mt-2 text-black font-bold text-sm shadow-md">
            ₹10,000.00
          </p>
        </div>
      </div>
      ...
      <div className="space-y-2 p-2">
        <div className="bg-body p-3 rounded flex justify-between">
      ...
      <div className="mt-4 px-4">
        ...
        <div>
          <p className="font-semibold mb-1 flex items-center">
            <span className="w-1 h-4 bg-red-400 mr-2 inline-block rounded-sm" />
            Invitation link
          </p>

          <div className="relative bg-body flex items-center rounded-full overflow-hidden text-sm w-full max-w-md partner-code">
            <span className="truncate px-4 py-2 text-black">
              {invitationLink}
            </span>
            <span
      ...
      {/* Invitation Rules */}
      <div className="mt-6 p-2 bg-body">
        <div className="text-black text-lg font-semibold mb-2 flex">
        ...
        {/* Bonus Table */}
        <div className="bg-[#f6f6f6] gray-text w-full overflow-x-auto">
          <div className="grid grid-cols-3 sheet_nav_bg border rounded-t-lg text-center font-semibold py-2 border-b border-gray-200 text-sm text-white">
            <div>Deposit</div>
          ...
          {[
            ...
            <div className="grid grid-cols-[1fr_3fr_1fr] text-center py-2 border-b border-[#E0DFE7] text-xs">
          ...
          {[
            ...
            <div className="grid grid-cols-[1fr_3fr_1fr] text-center py-2 text-xs border-b border-[#E0DFE7]">
              <div className="text-purple-400">
                {i === 0 ? "1st deposit" : ""}
              </div>
              <div>{item.amount}</div>
        ...
        {/* Notes */}
        <div className="mt-4 text-sm space-y-2 text-gray-500 p-2">
